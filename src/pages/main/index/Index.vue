          ...
          <div class="row g-5 py-5">
            <div class="col-lg-6 text-center text-lg-start">
              ...
              <p class="text-white pb-3 animate__animated animate__zoomIn">
                Tempor rebum no at dolore lorem clita rebum rebum ipsum rebum stet dolor sed justo kasd. Ut dolor sed
                magna dolor sea diam. Sit diam sit justo amet ipsum vero ipsum clita lorem
              </p>
              <a
                href=""
            ...
            <div class="col-lg-6 text-center text-lg-start">
              <img class="img-fluid" src="./../../../components/img/hero.png" alt="" />
            </div>
          </div>
        </div>
      </div>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      // eslint-disable-next-line @typescript-eslint/no-unused-vars, vue/return-in-computed-property
    ...
    watch: {
      DISTRIBUTOR_NAME(value) {
        ...
        console.log(data)
        this.getFundProfileFilterData(data)
      },
    },
    mounted() {
      this.getNAVlist()
    ...
    methods: {
      ...
      onSearch: async function () {
        ...
        const response = await this.services03Module5.fundDetailsMedia(data, data2)
      ...
      onsubmit: async function () {
        ...
        try {
          ...
          const response = await this.servicesModule5.verifyUser(data)
          ...
          if (response.TP_USER_ISLOGIN === 0) {
            ...
            this.servicesModule5.setUser(JSON.stringify(response.data))
      ...
      async filterNAV() {
        try {
          const response = await this.servicesModule5.getNAVlistMedia(this.model.modelFilter)
          if (response !== 'error') {
      ...
      getNAVlist: async function () {
        const response = await this.servicesModule5.getNAVlistMedia()
        this.navListRecordList = response
        this.navListRecordCount = this.navListRecordList.length
      },
      getDistributorMedia: async function () {
        const response = await this.servicesModule1.getDistributorMedia()
        this.distributor = response
      },
      async getFundProfileFilterData(data) {
        console.log(data)
        const response = await this.services03Module5.getFundProfileFilter(data)
        this.fund = response
      },
