    ...
    <div class="container-xxl py-5">
      <div class="container px-lg-5">
        <div class="row g-5">
            ...
            <div class="row g-6">
              <div class="col-sm-12">
                <div>
                  ...
                  <br />
                  <button type="button" class="ml-2 btn btn-sm btn-primary" @click="onSearch">Search</button>
                  <button type="button" class="ml-2 btn btn-sm btn-danger" @click="reset">Reset</button>
                </div>
                <va-separator />
                <div>
                  <div class="col">
                  ...
                  <div class="col">
                    <div class="row mb-1">
                      ...
                      <span class="description col">
                        <div v-if="details.FUND_TYPE_FULLNAME != null && details.FUND_TYPE_FULLNAME != ''">
                          {{ details.FUND_TYPE_FULLNAME }}
                        </div>
                        <div v-else-if="details.FUND_TYPE_FULLNAME == null || details.FUND_TYPE_FULLNAME == ''">-</div>
                      </span>
                    </div>
                  </div>
                  <div class="col">
                    <div class="row mb-1">
                      ...
                      <span class="description col">
                        <div v-if="details.GROUP_ASSET != null && details.GROUP_ASSET != ''">
                          {{ details.GROUP_ASSET }}
                        </div>
                        <div v-else-if="details.GROUP_ASSET == null || details.GROUP_ASSET == ''">-</div>
                      </span>
                    </div>
                  </div>
                  <div class="col">
                    <div class="row mb-1">
                      ...
                      <span class="description col">
                        ...
                        <div v-else-if="details.FUND_SYARIAH_COMP == null || details.FUND_SYARIAH_COMP == ''">-</div>
                      </span>
                    </div>
                  </div>
                  <div class="col">
                    <div class="row mb-1">
                      ...
                      <span class="description col">
                        ...
                        <div v-else-if="details.FUND_ASEAN_CIS_STATUS == null || details.FUND_ASEAN_CIS_STATUS == ''">
                          -
                        </div>
                      </span>
                    </div>
                  ...
                  <div class="col">
                    <div class="row mb-1">
                      ...
                      <span class="description col">
                        ...
                        <div v-else-if="details.FUND_STATUS_EPF == null || details.FUND_STATUS_EPF == ''">-</div>
                      </span>
                    </div>
                  </div>
                  <div class="col">
                    <div class="row mb-1">
                      ...
                      <span class="description col">
                        <div v-if="details.FUND_SCHEME != null && details.FUND_SCHEME != ''">
                          {{ details.FMS_SCHEME_NAME }}
                        </div>
                        <div v-else-if="details.FUND_SCHEME == null || details.FUND_SCHEME == ''">-</div>
                      </span>
                    </div>
                  </div>
                  <div class="col">
                    <div class="row mb-1">
                      ...
                      <span class="description col">
                        <div>
                          <b-table bordered :head-variant="'light'" :items="items" :fields="fields" show-empty>
          ...
          <div class="col-lg-6">
            <img class="img-fluid wow zoomIn" data-wow-delay="0.5s" src="./../../../components/img/about.jpg" />
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async filterNAV() {
        try {
          const response = await servicesModule5.getNAVlistMedia(this.model.modelFilter)
          if (response !== 'error') {
    ...
    computed: {
      ...
      navListFilteredData() {
        ...
        return this.navListRecordList.filter((item) => {
          return this.term.split(' ').every((v) => item.DIST_NAME.includes(v) || item.FUND_NAME.includes(v))
        })
      },
